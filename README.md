...
- The `Admin` screen includes topic cleanup, stable knowledge Promote/Delete controls, model warmup, performance benchmark runs, and a package health check.
...
launchctl kickstart -k gui/$(id -u)/com.williamtinney.codex-cli-ui
```
