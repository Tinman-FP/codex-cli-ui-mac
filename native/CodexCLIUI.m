...
- (void)startServer {
    NSString *serverPath = @"/Users/williamtinney/Applications/Codex_CLI_UI/server.py";
    ...
    task.currentDirectoryPath = @"/Users/williamtinney/Applications/Codex_CLI_UI";
    ...
    environment[@"CODEX_CWD"] = @"/Users/williamtinney/Documents/Codex";
    environment[@"QIDI_MOONRAKER_URL"] = @"http://192.168.50.145:7125";
...
- (void)loadErrorPage {
    ...
    "<p>The native app could not reach <code>127.0.0.1:8765</code>. Try restarting the app or running <code>/Users/williamtinney/Applications/Codex_CLI_UI/start.command</code>.</p>"
    "</main></body></html>";
    [self.webView loadHTMLString:html baseURL:nil];
}
