...
PUBLIC_FILES = [
    ...
    "structured_calculation.py",
    "golden_test_contract.py",
    "run_golden_batch.py",
...
PUBLIC_TOOL_FILES = [
    ...
    "tools/interaction_feedback_rehearsal.py",
    ...
    "tools/ebay_marketplace_smoke.py",
    "tools/engineering_calculator_smoke.py",
    "tools/structured_calculation_smoke.py",
    "tools/expertise_confidence_p5_smoke.py",
    "tools/live_feedback_smoke.py",
    "tools/interaction_director_p1_smoke.py",
    "tools/adversarial_understanding_replay.py",
    "tools/intelligence_kernel_smoke.py",
    "tools/capability_answer_architecture_smoke.py",
    "tools/capability_execution_contract_smoke.py",
    "tools/capability_executor_smoke.py",
    "tools/capability_route_coverage_smoke.py",
    "tools/evidence_provenance_contract_smoke.py",
    "tools/answer_relevance_contract_smoke.py",
    "tools/terminal_state_contract_smoke.py",
    "tools/turn_lineage_contract_smoke.py",
    "tools/p177_generic_satisfaction_verifier_smoke.py",
    "tools/p179_verified_satisfaction_cache_smoke.py",
    "tools/p179_cached_satisfaction_ui_contract.mjs",
    "tools/p180_local_action_retry_ui_contract.mjs",
    "tools/p181_answer_obligation_contract_smoke.py",
    "tools/p182_reasoning_review_protocol_smoke.py",
    "tools/p184_compact_reasoning_review_smoke.py",
    "tools/p185_primary_author_recovery_smoke.py",
    "tools/p186_nonnumeric_comparison_contract_smoke.py",
    "tools/p187_typed_residual_capability_ownership_smoke.py",
    "tools/p188_live_device_authority_contract_smoke.py",
    "tools/p189_ollama_budget_telemetry_smoke.py",
    "tools/p191_typed_output_authority_contract_smoke.py",
    "tools/p193_feedback_turn_receipt_smoke.py",
    "tools/p193_feedback_turn_receipt_ui_contract.mjs",
    "tools/p194_typed_comparison_primary_prompt_smoke.py",
    "tools/p195_terminal_supervision_reconciliation_smoke.py",
    "tools/p196_runtime_introspection_contract_smoke.py",
    "tools/p197_load_derived_drive_reasoning_smoke.py",
    "tools/p202_intent_noop_and_shopping_evidence_smoke.py",
    "tools/p208_written_quantity_evidence_smoke.py",
    "tools/p209_source_free_epistemic_calibration_smoke.py",
    "tools/p210_multi_layer_power_system_ownership_smoke.py",
    "tools/p211_package_health_progress_timeout_smoke.py",
    "tools/p220_package_health_harness_smoke.py",
    "tools/p221_live_smoke_source_binding_smoke.py",
    "tools/p222_package_supervisor_deadline_contract_smoke.py",
    "tools/p223_qualified_referent_resolution_smoke.py",
    "tools/p224_verification_metric_semantics_smoke.py",
    "tools/p225_live_smoke_suite_semantics_smoke.py",
    "tools/p226_systemic_root_repairs_smoke.py",
    "tools/p227_package_contract_reconciliation_smoke.py",
    "tools/p231_bounded_attachment_resolution_smoke.py",
    "tools/p232_package_attachment_contract_smoke.py",
    "tools/p233_cold_satisfaction_resolution_smoke.py",
    "tools/p234_terminal_done_contract_smoke.py",
    "tools/p235_research_apply_phase_budget_smoke.py",
    "tools/p237_behavior_guidance_preflight_smoke.py",
    "tools/p238_verification_snapshot_latency_smoke.py",
    "tools/p239_adaptive_response_composition_smoke.py",
    "tools/p240_package_runner_concurrency_smoke.py",
    "tools/p242_p227_package_isolation_smoke.py",
    "tools/p243_user_facing_frontier_audit_smoke.py",
    "tools/p247_package_diagnostic_fidelity_smoke.py",
    "tools/p248_clarification_dependent_followup_smoke.py",
    "tools/p249_exclusive_package_lane_smoke.py",
    "tools/p250_controller_template_completion_smoke.py",
    "tools/p251_bounded_specialist_producer_smoke.py",
    "tools/p252_local_file_completion_smoke.py",
    "tools/p253_source_bound_specialist_relevance_smoke.py",
    "tools/p254_final_relevance_propagation_smoke.py",
    "tools/p255_package_hermetic_deadline_smoke.py",
    "tools/p256_package_resource_scheduler_smoke.py",
    "tools/p256_package_synthetic_worker.py",
    "tools/p257_verification_telemetry_isolation_smoke.py",
    "tools/p258_contextual_clarification_contract_smoke.py",
    "tools/generic_typed_capability_smoke.py",
    "tools/live_generic_typed_conversation_smoke.py",
    "tools/live_typed_capability_conversation_smoke.py",
    ...
    "tools/generated_smoke_artifact_audit.py",
    "tools/release_privacy_scan.py",
    "tools/release_privacy_scan_smoke.py",
...
def sanitize_text(text):
    ...
    text = text.replace("williamtinney", "localuser")
    text = text.replace("William Tinney", "Local Maintainer")
    return text
